...
var pluginName = getParam("pluginName"),
    version = getParam("version", "latest");
...
var cmd = "curl --silent https://raw.githubusercontent.com/jelastic-jps/wordpress/master/cli/japp.sh > ~/bin/japp.sh && bash ~/bin/japp.sh updatePlugin --pluginName " + pluginName + " --version " + version;
